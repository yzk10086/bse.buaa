...
const routes = [
  ...
  },
  {
    ...
    name: "pca_3d_author",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/PCA_3d_author.vue"),
  },
  {
    path: "/pca_2d_venue",
    name: "pca_2d_venue",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/PCA_2d_venue.vue"),
  },
  {
    path: "/variance_TE",
    name: "variance_TE",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/Variance_TE.vue"),
  },
  {
    path: "/variance_TE_10",
    name: "variance_TE_10",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/Variance_TE_10.vue"),
  },
  {
    path: "/variance_TE_20",
    name: "variance_TE_20",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/Variance_TE_20.vue"),
  },
  {
    path: "/variance_venue",
    name: "variance_venue",
  ...
  },
  {
    ...
    name: "tsne_venuegood",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/TSNE_venue.vue"),
  },
  {
    path: "/tsne_venuebad",
    name: "tsne_venuebad",
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/TSNE_venuebad.vue"),
  },
];
